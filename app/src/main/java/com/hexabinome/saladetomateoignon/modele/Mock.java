...
public final class Mock {
    ...
    public static ArrayList<Restaurant> getRestaurantLaDoua() {
        ...
        preference.add(new Restaurant("CROUS : Restaurant universitaire", 3.20, 15, 3,
                Restaurant.TypePointDeRestauration.RESTAURANT_UNIVERSITAIRE, null, 4.876355, 45.780984,"Restaurant universitaire du Crous"));
        preference.add(new Restaurant("L'Olivier", 4.40, 25, 3,
                Restaurant.TypePointDeRestauration.RESTAURANT_UNIVERSITAIRE, null, 4.878014, 45.782281, "Restauration italienne"));
        preference.add(new Restaurant("Grillon", 4.40, 20, 4,
                Restaurant.TypePointDeRestauration.RESTAURANT_UNIVERSITAIRE, null, 4.874866, 45.784130,"Restaurant grill"));
        preference.add(new Restaurant("La grignotte", 5.30, 5, 3,
                Restaurant.TypePointDeRestauration.RESTAURANT_UNIVERSITAIRE, null, 4.874866, 45.784130,"Si tu veux grignoter!"));
        preference.add(new Restaurant("Le Castor et Pollux", 4.40, 10, 1,
                Restaurant.TypePointDeRestauration.RESTAURANT_UNIVERSITAIRE, null, 4.869037, 45.783846, "Restaurant self-service traditionnel"));
